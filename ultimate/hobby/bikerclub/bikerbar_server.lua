...
vioSetElementData ( MistysFreeway1, "owner", "console" )
...
vioSetElementData ( MistysFreeway2, "owner", "console" )
...
vioSetElementData ( MistysFreeway4, "owner", "console" )
...
function bikerBarBuyQue_func ( player )
	...
	if vioGetElementData ( player, "club" ) == "biker" then
		...
		if money >= quePrice then
			vioSetElementData ( player, "money", money - quePrice )
...
function bikerBarJoin_func ( player )
	...
	if vioGetElementData ( player, "club" ) == "biker" then
		...
		if money >= 100 then
			...
			playSoundFrontEnd ( player, 40 )
			vioSetElementData ( player, "club", "biker" )
...
function bikerBarBuySkin_func ( player )
	...
	if vioGetElementData ( player, "club" ) == "biker" then
		local money = tonumber ( vioGetElementData ( player, "money" ) )
		if vioGetElementData ( player, "money" ) >= outfitPrice then
			vioSetElementData ( player, "money", money - outfitPrice )
			playSoundFrontEnd ( player, 40 )
			vioSetElementData ( player, "skinid", 254 )
