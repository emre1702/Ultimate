...
function drugsSellHobby_func ( amount )
	...
	if vioGetElementData ( player, "club" ) == "gartenverein" then
		...
		if drugs >= amount then
			...
			vioSetElementData ( player, "money", vioGetElementData ( player, "money" ) + amount * 12 )
...
function BuyFlowersServer_func ()
	...
	if vioGetElementData ( player, "club" ) == "gartenverein" then
		...
		if money >= 500 then
			vioSetElementData ( player, "money", money - 500 )
			
			vioSetElementData ( player, "flowerseeds", seeds + 10 )
