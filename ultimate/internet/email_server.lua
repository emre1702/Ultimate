...
function sendMail_func ( text, betreff, to )
	...
	if exists then
		local mail = tostring ( getPlayerName(client).."@Ultimate-RL.de|"..betreff.."|"..timestamp()..": "..text )
		...
		outputChatBox ( "Ungueltige Eingabe, bitte verwende folgende Eingabe: [Name@Ultimate-RL.de]", client, 125, 0, 0 )
	end
end
