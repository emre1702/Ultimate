...
function showWebbrowser ( url, prev )
	...
	if gWindow["basicMainPage"] then
		...
		gWindow["basicMainPage"] = guiCreateWindow(screenwidth/2-419/2,screenheight/2-373/2,419,373,"Ultimate.NET Explorer",false)
		...
		guiLabelSetColor(gLabel["webbrowserInfo1"],200,200,255)
