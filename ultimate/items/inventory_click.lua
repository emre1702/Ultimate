...
itemImage = { ["Zeitung"]="liberty_tree.bmp",
 ["Kanister"]="benzin.bmp",
 ["Drogen"]="drugs.bmp", 
 ["Materialien"]="mats.bmp", 
 ["Wuerfel"]="dice.bmp",
 ["Zigaretten"]="cigaretts.bmp",
 ["Erste Hilfe"]="aid.bmp",
 ["Bier"]="beer.bmp",
 ["Burger"]="burger.bmp",
 ["Snack"]="snack.bmp",
 ["Suessigkeiten"]="suess.bmp",
 ["Hanfsamen"]="drugs.bmp",
 ["Ehre"]="orden_1.bmp",
 ["Luftwaffe"]="orden_2.bmp",
 ["Verdienst"]="orden_3.bmp",
 ["Notebook"]="fruit.bmp",
 ["Handheld"]="gbc.bmp",
 ["Chips"]="chip.png",
...
function newSelection ()
	...
	if selectedText then
		...
		elseif placeAbleObjects[selectedText] then
			local addtext = ""
			if placeAbleObjectDesc[vioClientGetElementData ( "object" )] then
				addtext = addtext..placeAbleObjectDesc[vioClientGetElementData("object" )]
			end
			if gImage["itemImage"] then
				destroyElement ( gImage["itemImage"] )
			end
