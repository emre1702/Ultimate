function showBauingWindow ()
	...
	gLabel[3] = guiCreateLabel(174,28,40,17,tostring ( vioClientGetElementData ( "bauarbeiterLVL" ) ), false,gWindow["BauSelection"])
	...
	false )
	if vioClientGetElementData ( "bauarbeiterLVL" ) >= 500 then
		txt = "Comming soon!"
	else
		txt = "Comming soon!"
	end
